...
public class ModBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, CBC_Ballistics.MODID);

    private static final CreateRegistrate REGISTRATE = CBC_Ballistics.REGISTRATE;
